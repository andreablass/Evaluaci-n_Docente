...
<div class="container col-md-10 offset-md-1">
    <center>
        <div class="p-3 mb-2 bg-success ">EVALUACIÓN</div>
    </center>
    ...
    <form action="<%=context%>/ServletRegistroRespuestas" method="POST">
        ...
        <div class="col-md-12">
        <table class="table table-bordered table-striped table-hover table-center" style="background-image: linear-gradient( 89.8deg, rgba(74,140,203,1) 10.9%, rgba(74,203,138,1) 78.9% );">
            <h4>
            ...
            <tr>
                ...
                <td><input type="radio" name="<%=nameCounter%>" value="2" id="RadioGroup1<%=nameCounter%>" />
                    </label>
                </td>
                <td>
                    <label>
                        <input type="radio" name="<%=nameCounter%>" value="4" id="RadioGroup2<%=nameCounter%>" />
                    </label>
                </td>
                <td>
                    <label>
                        <input type="radio" name="<%=nameCounter%>" value="6" id="RadioGroup3<%=nameCounter%>" />
                    </label>
                </td>
                <td>
                    <label>
                        <input type="radio" name="<%=nameCounter%>" value="8" id="RadioGroup4<%=nameCounter%>" />
                    </label>
                </td>
                <td>
                    <label>
                        <input type="radio" name="<%=nameCounter%>" value="10" id="RadioGroup5<%=nameCounter%>" />
                    </label>
                </td>
            </tr>
            <% } %>
        ...
        <table class="table table-bordered table-striped table-hover" style="background-color:#5ED7A2;">
            ...
            <div><button id="btnSumar" class="btn btn-danger btn-lg btn-block" style="background-color: #132D5E;"><h2>EVALUAR</h2></button></div>
    </div>
