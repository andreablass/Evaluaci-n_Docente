...
<%
    ...
    List<BeanPregunta> comentarios = new ArrayList<>();

    if (request.getSession().getAttribute("comentarios") != null) {
        comentarios = (List) request.getSession().getAttribute("comentarios");
    }
...
<center>
    <div class="p-3 mb-2 bg-success text-white">Comentarios</div>
</center>
...
<center>
    <table class="table table-hover">
        <thead>
        <tr>
            <th scope="col">Identificador de comentario</th>
            <th scope="col">Descripción</th>

        </tr>
        </thead>
        <tbody>
        <% for (BeanPregunta comentario : comentarios) { %>
        <tr>
            <th scope="row"><%=comentario.getId()%>
            </th>
            <td><%=comentario.getDescripcion()%>
            </td>
...
<div class="card-deck">
    <div class="card">
        <div class="card-body">
            <form action="<%=context%>/ServletComentario">
                <h1>Agregar</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="<%=context%>/ServletComentario">
                ...
                <div class="form-group">
                    <label>Identificador del comentario</label>
