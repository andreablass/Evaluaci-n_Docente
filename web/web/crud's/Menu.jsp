        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <button type="submit" class="btn btn-primary" id="Docentes" value="Docentes">Docentes</button>
                    </form>
                </li>
                ...
                <li class="nav-item">
                   ...
                   <form action="<%=context%>/crud's/CRUDGrupo.jsp">
                    <button type="submit" class="btn btn-primary" id="Grupos" value="Grupos">Grupos</button>
                   </form>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <button type="submit" class="btn btn-primary" id="Evaluacion" value="Evaluacion">Evaluacion</button>
                    </form>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <button type="submit" class="btn btn-primary" id="Periodos" value="Periodos">Periodos</button>
                    </form>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <button type="submit" class="btn btn-primary" id="Reportes" value="Reportes">Reportes</button>
                    </form>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <button type="submit" class="btn btn-primary" id="Administradores" value="Administradores">Administradores</button>
                    </form>
                </li>
    ...
    <tr>
        ...
        <td>
            <center>
                <table>
                    <tr>
                        <h1>Evaluación Docente Interna UTEZ</h1>
                    </tr>
                    <tr>
                        <h2>DATIC</h2>
                    </tr>
