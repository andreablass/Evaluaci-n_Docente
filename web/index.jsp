  ...
  <div class="container login-container">
    <div class="row">
      <div class="col-md-6 login-form-1">
        ...
        <form action="<%=context%>/ServletValidarAlum" method="POST">
      ...
      <div class="col-md-6 login-form-2">
        ...
        <form action="<%=context%>/ServletValidarAdm" method="post">
          <div class="form-group">
            <input name="nombreUsuario" type="text" class="form-control" placeholder="Nombre usuario">
          </div>
          <div class="form-group">
